    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4" x-data="{ show: @entangle('showModal') }"
        ...
        <div class="relative bg-card border border-border rounded-xl shadow-2xl max-w-md w-full p-6"
            ...
            <div class="flex items-start gap-4 mb-6">
                <div class="shrink-0 w-12 h-12 bg-destructive/10 rounded-full flex items-center justify-center">
                ...
                <div class="flex-1">
                    <h3 class="text-xl font-bold text-card-foreground mb-2">Delete Note</h3>
                    <p class="text-sm text-muted-foreground">
                        Are you sure you want to delete
                        <span class="font-semibold text-foreground">"{{ $noteTitle }}"</span>?
                    </p>
